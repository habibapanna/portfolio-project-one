...
const Services = () => {
  return (
    <div>
      <section
        id="services"
        className="py-20 bg-violet-200 rounded-[100px] mt-10"
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="text-center">
              <div className="mx-auto inline-flex items-center rounded-full px-4 py-2 bg-[#eef6f9] border border-gray-300 shadow-sm">
                ...
                <span className="text-[#0f1724]">Services</span>
              </div>
          ...
          >
            <div className="text-center mt-14 flex justify-center gap-6">
              <button className="px-8 py-3 rounded-lg bg-gradient-to-br from-[#1f2740] to-[#152032] text-white font-medium shadow-md flex items-center justify-center text-sm">
